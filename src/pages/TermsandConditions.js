    ...
    <container>
      <div style={{ marginTop: "35px" }}>
        ...
        <p className="fs-5">
          ...
          PRIVACY POLICY, RISK POLICY AND AML/KYC AML/CTF POLICY THAT, MUTUALLY
          WITH THIS LEGAL DOCUMENT, REPRESENT THE SET OF LEGAL CLAUSES APPLIED
        ...
        <ul>
          ...
          <li>
            <h4>
              limit any of the Service Provider’s liabilities in any way that is
        ...
        <ul>
          ...
          <li>
            <h4>
              that you understand and agree that our relationship may be amended
              from time to time, in which case you automatically agree to such
              modifications
            </h4>
          </li>
        </ul>
        ...
        <h4 className="fs-4 fw-normal " style={{ marginTop: "20px" }}>
          ...
          services described on our website at any given time, which are made
          available through the website, third party platform or directly to
          select collaborators and users, and subject to this agreement.
        ...
        <h4 className="fs-4 fw-normal " style={{ marginTop: "20px" }}>
          ...
          anti-money laundering or sanctions legislation) in force from time to
          time.
        </h4>
        ...
        <h4 className="fs-4 fw-normal " style={{ marginTop: "20px" }}>
          ...
          billing sources, and digital identification. The User also undertakes
          that during the validity of the contract it will keep data updated,
          accurate and true. The User is responsible for keeping any security
          information safe and secure. The User must not disclose these details
        ...
        <h4 className="fs-4 fw-normal " style={{ marginTop: "20px" }}>
          ...
          User’s Personal Information is lost or stolen, or if there are reasons
          to believe that the Services has been accessed by an unauthorized
          user, the User is required to immediately contact our Support Service.
          Notwithstanding any provision to the contrary, nothing in this
          document shall be construed, interpreted or applied to impose
        ...
        <ul>
          ...
          <li>
            <h4>
              ...
              interference of any data system or network, unauthorized
              collection or use of e-mail addresses, screen names or other
              identifiers, use of the Services to distribute software that
              covertly gathers information about a user or covertly transmits
              information about the user, monitoring data or traffic on any
              network or system without the express authorization of the owner
          ...
          <li>
            <h4>
              ...
              material that is protected by copyright, trademark, trade secret,
              or any other intellectual property rights. Any usage that prompts
              the receipt of abuse complaints pertaining to violation of any
          ...
          <li>
            <h4>
              Any conduct that is likely to result in retaliation against our
          ...
          <li>
            <h4>
              ...
              our systems or networks, or to breach our security or
        ...
        <ul>
          ...
          <li>
            <h4>
              ...
              User’s security or that there is a threat to the User’s security
            </h4>
          </li>
          <li>
            <h4>
              when the User’s activity or conduct is such that we believe acting
              reasonably at all times has or is likely to impair the integrity,
              functionality, speed or reliability of our organization or
              compromise, impair, restrict or prevent our ability to operate a
        ...
        <h4 className="fs-4 fw-normal ">
          ...
          the email address. If we elect to close the User’s Services, where
          possible the User will have 14 working days to close any undergoing
          operations. If the User has not closed all undergoing operations
          within the 14 days provided, we shall be entitled to close all
          operations the next Business Day. The circumstances where we may close
          the User’s Services include but are not limited to where:
        </h4>
        <ul>
          <li>
            <h4>
              the User repeatedly fails to provide information requested, when
              we believe that we require such information in connection with
              this document;
            </h4>
          </li>
          <li>
            <h4>
              the User has persistently acted in an abusive manner toward our
              staff (for example by performing what we consider to be a serious
              discourtesy or the use of offensive or insulting language);
            </h4>
          </li>
          <li>
            <h4>
              the information provided to us as part of the application process
              to open the User’s Services is demonstrably untrue;
            </h4>
          </li>
          <li>
            <h4>
              in our opinion, the User’s operations are likely to have a
              negative impact on the quality of the our Services and, therefore,
              a potential detrimental effect on the members of chaidex.com alias
              ChaiDEX community
            </h4>
          </li>
        </ul>
        ...
        <h4 className="fs-4 fw-normal ">
          ...
          future materials and services, including, but without limitation to,
          copyrights, patents, trademarks, and trade secrets, works, images,
          pictures, dialogues, music, sounds, videos, documents, drawings,
          figures, logos and any other material published on
          https://chaidex.com/, including menus, web pages, graphics, colors,
          schemes, tools, the website's fonts and design, diagrams, layouts,
          methods, processes, functions and software which are part of
          https://chaidex.com/, and are protected by copyright and by all other
          intellectual property rights. The User's possession, access, and use
          of our services do not transfer to the User, or to any third party,
        ...
        <ul>
          <li>
            <h4>Republish material from https://chaidex.com/</h4>
          </li>
          <li>
            <h4>
              Sell, rent or sub-license material from https://chaidex.com/
            </h4>
          </li>
          <li>
            <h4>
              Reproduce, duplicate or copy material from https://chaidex.com/
            </h4>
          </li>
          <li>
